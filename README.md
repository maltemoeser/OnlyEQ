...
- **Adjust pane** in the editor: Bass, Treble, Tilt, and Strength sliders that sit over an imported profile without editing its bands, for warming up or brightening a correction you otherwise leave alone. Saved with the preset; Compare, Bypass, Revert, and Undo all include it.
