...
- **Crossfeed** for headphones (Bauer-style low-pass and 0.3 ms delay, with the near ear giving up the bass the far ear receives so centred content passes at unity). Toggle in the popover and the editor; Settings › Sound offers the three published bs2b settings (Natural, Chu Moy, Jan Meier) or a custom amount and cutoff.
